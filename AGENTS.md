...
- The local development architecture may include MinIO as a self-hosted S3-compatible persistence layer for LiteLLM cold storage and session continuity.
...
- When documenting persistence, describe MinIO as local infrastructure for LiteLLM cold storage, not as an application-facing dependency.
